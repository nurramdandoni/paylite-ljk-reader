import numpy as np
import cv2
img = cv2.imread('LJK_Paylite_Edu_mark_fc.jpg')
...
for i, c in enumerate(contours):
    ...
    if area < 1000 :
        ...
        #     print("Bintang")
            ...
            if area > 200:
                lingkaran_centers.append(cX)
                lingkaran_centers.append(cY)
...
all_centers = [lingkaran_centers,kotak_centers,persegi_centers,segitiga_centers]
print("lingkaran_centers :::: ",lingkaran_centers)
print("kotak_centers :::: ",kotak_centers)
print("persegi_centers :::: ",persegi_centers)
print("segitiga_centers :::: ",segitiga_centers)

# Pastikan all_centers berisi koordinat x dan y untuk setiap bentuk
# Misalnya: [[x_lingkaran, y_lingkaran], [x_kotak, y_kotak], [x_persegi, y_persegi], [x_segitiga, y_segitiga]]

# # Mengasumsikan all_centers diisi dengan benar dan sudah dalam urutan yang tepat
# pts_src = np.array([all_centers[0], all_centers[1], all_centers[2], all_centers[3]], dtype="float32")

# # Titik-titik destinasi, asumsikan kita ingin memproyeksikan ke persegi 800x800
# pts_dst = np.array([[0, 0], [800, 0], [0, 800], [800, 800]], dtype="float32")
...
for i in range(num_boxes_height):
    ...
    for j in range(num_boxes_width):
        ...
        cv2.rectangle(roi_crop, (start_x, start_y), (end_x, end_y), (150, 150, 150), 1)
        # if i == 0:
        ...
        #     # Gambar kotak dengan warna hijau
              cv2.rectangle(roi_crop, (start_x, start_y), (end_x, end_y), (0, 255, 0), 3)
...
# cv2.imshow("Mapping :: Step 3", threshCrop)
